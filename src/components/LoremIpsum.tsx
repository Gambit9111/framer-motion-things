export function LoremIpsum() {
    return (
      <>
        <article className="text-lg max-w-lg p-5 mx-auto">
          <p className="mb-8">
          ...
          <h2 className="my-12 mt-2.5 text-2xl">Sub-header</h2>
          <p className="mb-8">
          ...
          <p className="mb-8">Sed sem nisi, luctus consequat ligula in, congue sodales nisl.</p>
          <p className="mb-8">
          ...
          <p className="mb-8">Quisque convallis ligula non magna efficitur tincidunt.</p>
          <p>
            Pellentesque id lacus pulvinar elit pulvinar pretium ac non urna.
            Mauris id mauris vel arcu commodo venenatis. Aliquam eu risus arcu.
            Proin sit amet lacus mollis, semper massa ut, rutrum mi.
